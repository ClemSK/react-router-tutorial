...
export default function ProductDetails() {
  ...
  return (
    <div className="content">
      ...
      {/* the relative path is doing more work for you
        so you don't need to specify the id of the item, 
        it will do that for you by default as part of the default behavior */}
      <Routes>
